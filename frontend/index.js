...
//Vaatedatan hakeminen palvelimelta fetch()
async function getVaatteet() {
 ...
 // vaatteet käydään silmokassa läpi ja jokaiselle lisätään taulukkorivi
...
// käytä tätä palautustehtävässä tätä taulukko mallia VINKKI!!